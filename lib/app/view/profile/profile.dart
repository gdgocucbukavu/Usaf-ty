                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Gap(sizeHeight * 0.02),
                        GestureDetector(
                          child: listPuller(context, sizeWidth, AppIcons.langue,
                              "Langue", AppColors.tdBlueC),
                          onTap: () => bottomSheetLangage(
                              context, sizeHeight, sizeWidth, theme),
                        ),
                        GestureDetector(
                          child: listPuller(context, sizeWidth, AppIcons.about,
                              "Apropos", AppColors.tGYellowC),
